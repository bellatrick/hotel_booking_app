...
const Header = () => {
  ...
  return (
    <div className="bg-primary  py-6">
      <div className="container gap-6 px-8 lg:px-6 mx-auto flex flex-col sm:flex-row justify-between">
        <span className="md:text-2xl text-xl text-white font-bold tracking-tight">
